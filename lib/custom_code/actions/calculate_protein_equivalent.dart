...
double calculateProteinEquivalent(
  ...
  if (!foodProteins.containsKey(food1Name)) {
    throw Exception("Alimento 1 não encontrado na lista!");
  }
  if (!foodProteins.containsKey(food2Name)) {
    throw Exception("Alimento 2 não encontrado na lista!");
  }

  final protein1 = foodProteins[food1Name]!;
  final protein2 = foodProteins[food2Name]!;

  return ((protein1 * quantity) / protein2).roundToDouble();
}
