...
import 'login_c_a_d_a_s_t_r_o_model.dart';
export 'login_c_a_d_a_s_t_r_o_model.dart';

class LoginCADASTROWidget extends StatefulWidget {
  const LoginCADASTROWidget({super.key});

  static String routeName = 'login_CADASTRO';
...
class _LoginCADASTROWidgetState extends State<LoginCADASTROWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'login_CADASTRO'});
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model
                                          ...
                                          if (_model.checkTermosValue != true) {
                                            await showDialog(
                                              context: context,
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: Text(
                                                      'Termos e Condições'),
                                                  content: Text(
                                                      'Você precisa aceitar os termos e condições de uso do aplicativo.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
