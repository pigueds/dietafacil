...
import '/index.dart';
import 'dados_do_usuario_pagamento_widget.dart'
    show DadosDoUsuarioPagamentoWidget;
...
class DadosDoUsuarioPagamentoModel
    extends FlutterFlowModel<DadosDoUsuarioPagamentoWidget> {
  ...
  ApiCallResponse? clienteCriado;
  // Stores action output result for [Backend Call - API (Criar Card id)] action in Button widget.
  ApiCallResponse? cardIdCriado;
  // Stores action output result for [Backend Call - API (Compra com card id)] action in Button widget.
  ApiCallResponse? compraConcluida;
